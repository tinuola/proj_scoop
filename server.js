...
//Edit a comment
function editComment(url, request) {
...
function deleteComment(url, request) {
  ...
  if (id && savedComment) {
    ...
    const userCommentIds = database.users[savedComment.username].commentIds.indexOf(id);
    database.users[savedComment.username].commentIds.splice(userCommentIds, 1);

    const userArticleIds = database.articles[savedComment.articleId].commentIds.indexOf(id);
    database.articles[savedComment.articleId].commentIds.splice(userArticleIds, 1);
